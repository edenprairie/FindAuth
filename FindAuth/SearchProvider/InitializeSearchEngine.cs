...
namespace CVS.Novologix.TransactionSearch.SearchProvider
{
	public class InitializeSearchEngine
	{
		...
		public void SaveToElasticsearchStateProvinceIfitDoesNotExist()
		{
			...
			//using (var elasticSearchContext = new ElasticsearchContext("http://sqlprod01:9200/", new ElasticsearchSerializerConfiguration(elasticsearchMappingResolver, true, true)))
			//{
